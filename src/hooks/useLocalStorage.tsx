...
export interface LocalStorageProps<T> {
    ...
    setStorageValue: (value: T | undefined) => void | T | undefined,
    getStoredValue: T | undefined,
}

// Hook
function useLocalStorage<GetType>(key: string, initialValue: GetType | undefined = undefined): LocalStorageProps<GetType> {
    ...
    const setStorageValue = useCallback(
        (value: GetType | undefined) => {
            try {
                // Allow value to be a function so we have same API as useState
                // Save state
                setStoredValue((data: GetType | undefined) => {
